...
#define STM32_ADC_CHANNE_VOLTAGE_Pin GPIO_PIN_4
#define STM32_ADC_CHANNE_VOLTAGE_GPIO_Port GPIOA
#define STM32_ADC_CHANNE_CURRENT_Pin GPIO_PIN_5
#define STM32_ADC_CHANNE_CURRENT_GPIO_Port GPIOA
