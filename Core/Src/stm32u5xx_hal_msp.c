...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = STM32_SLEEP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(STM32_SLEEP_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA6     ------> ADC4_IN11
    */
    GPIO_InitStruct.Pin = CONTROLPILOT_STM32_ADC_CHANNE_VOLTAGE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CONTROLPILOT_STM32_ADC_CHANNE_VOLTAGE_GPIO_Port, &GPIO_InitStruct);

    /* ADC4 DMA Init */
    /* LPDMA1_REQUEST_ADC4 Init */
    handle_LPDMA1_Channel0.Instance = LPDMA1_Channel0;
    handle_LPDMA1_Channel0.Init.Request = LPDMA1_REQUEST_ADC4;
    ...
    handle_LPDMA1_Channel0.Init.Priority = DMA_LOW_PRIORITY_MID_WEIGHT;
    ...
    __HAL_LINKDMA(hadc, DMA_Handle, handle_LPDMA1_Channel0);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(STM32_SLEEP_GPIO_Port, STM32_SLEEP_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PA6     ------> ADC4_IN11
    */
    HAL_GPIO_DeInit(CONTROLPILOT_STM32_ADC_CHANNE_VOLTAGE_GPIO_Port, CONTROLPILOT_STM32_ADC_CHANNE_VOLTAGE_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    */
    ...
    __HAL_LINKDMA(hi2c, hdmatx, handle_GPDMA1_Channel2);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = OLED_SCK_PIN_Pin|OLED_MOSI_PIN_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, OLED_SCK_PIN_Pin|OLED_MOSI_PIN_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    PE0     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = CONTROLPILOT_STM32_GPIO_PWM_PIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF14_TIM16;
    HAL_GPIO_Init(CONTROLPILOT_STM32_GPIO_PWM_PIN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB6     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = PZEM004T_RX_PIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(PZEM004T_RX_PIN_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = PZEM004T_TX_PIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(PZEM004T_TX_PIN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(PZEM004T_RX_PIN_GPIO_Port, PZEM004T_RX_PIN_Pin);

    HAL_GPIO_DeInit(PZEM004T_TX_PIN_GPIO_Port, PZEM004T_TX_PIN_Pin);
